...
class TagCompletions(sublime_plugin.EventListener):
    def on_query_completions(self, view, prefix, locations):
        ...
        return ([
            ...
            # TODO: GenerateApplicationManifest items
            ...
            ("MSBuild [Simple]", "MSBuild Projects=\"${1:@(Projects)}\" Targets=\"$2\" Properties=\"$3\" />"),
